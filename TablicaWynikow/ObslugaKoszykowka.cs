...
namespace TablicaWynikow
{
    public partial class ObslugaKoszykowka : Form
    {
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            if(this.ownerForm.whichQuart() == "1")
            {
                this.ownerForm.SetTime(Settings.Default.CzasGry.ToString("00"), "00", "0");
                this.ownerForm.action("24", "0");
            }
        ...
        private void ObslugaKoszykowka_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.A)
            {
                this.ownerForm.StartStopClock(false);
            ...
            {
                this.ownerForm.StartStopClock(true);
                this.ownerForm.StartStopClock24(true);
            }
        }
