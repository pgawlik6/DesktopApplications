    ...
    public partial class FormSiatkowka : Form
    {
        ...
        private void Color_Load()
        {
            if (Settings.Default.KolorCzcionka.Substring(0, 2) == "ff")
            {
                ...
                Goscie.ForeColor = Color.FromArgb(argb);
                Gospodarze.ForeColor = Color.FromArgb(argb);
            ...
            else
            {
                ...
                Goscie.ForeColor = Color.FromName(Settings.Default.KolorCzcionka);
                Gospodarze.ForeColor = Color.FromName(Settings.Default.KolorCzcionka);
